      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            <div className="text-lg space-y-6 text-lg leading-[1.8] whitespace-pre-line">
        ...
        <div className="relative p-4 flex justify-center items-center">
          ...
          <div className="relative z-10 group bg-muted rounded-[1.5rem] overflow-hidden border-[10px]"
          style={{borderColor: '#B0C9D6',
            ...
            {image ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-muted-foreground">
                <svg className="w-74 h-74 opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
