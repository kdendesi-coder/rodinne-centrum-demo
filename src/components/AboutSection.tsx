...
const AboutSection = () => {
  ...
  const { text: savedImage, setText: setSavedImage } = useParagraph("about_image");
  ...
  const handleSaveText = async (value: string | string[]) => {
    const newText = Array.isArray(value) ? value[0] : value;
      ...
      <div className="w-full max-w-[1650px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative p-4 sm:p-6 flex justify-center items-center overflow-hidden lg:overflow-visible">
            ...
            <div
              className="relative z-10 group bg-muted rounded-[1.5rem] overflow-hidden border-[4px] sm:border-[10px] w-full max-w-[750px] aspect-[3/2]"
              style={{
                borderColor: "#B0C9D6",
