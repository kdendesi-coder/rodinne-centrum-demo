  ...
  return (
    <section id="team" className="py-20 px-4 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl text-[#5E7322] md:text-4xl font-bold mb-4">Náš tím :)</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 ml-6">
          {members.map((member, index) => (
            <div key={index} className="group/member">
              <div className="relative mb-4 inline-block">
                <div className="w-48 h-48 rounded-3xl bg-muted mx-auto flex justify-center overflow-hidden">
                  {member.image ? (
              ...
              <div className="relative group/name block">
                <h3 className="font-semibold text-[#5E7322]">{member.name}</h3>
